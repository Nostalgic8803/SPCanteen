    ...
    <div class="flex flex-col min-h-screen">
      ...
      <div class="flex flex-col bg-white mt-4 ml-4 mr-5 w-96">
        <div class="flex flex-col items-center mb-3 mt-5">
          <img style="width: 350px; height: 180px;" src="https://insanelygoodrecipes.com/wp-content/uploads/2020/04/Fried_Chicken.png" alt="">
        ...
        <div class="font-bold">
          <h1 class="font-bold text-2xl ml-5 mt-2 mb-4">Fried Chicken</h1>
        </div>
      </div>
      <div class="flex flex-col bg-white mt-10 ml-4 mr-5 w-96">
        <div class="flex flex-col items-center mb-3 mt-5">
          <img style="width: 350px; height: 180px;" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTm0UeAXM4VHMiUmXvA2Vy4XbjtrJVc-PPOKcs56zBB-w&s" alt="">
          <div class="absolute bg-white w-10 h-10 rounded-full" style="margin: 8px 0 0 18em;">
            <i class="fas fa-heart text-2xl" style="color: lightgray; margin: 5px 0 0 8px;"></i>
          </div>
        </div>
        ...
        <div class="font-bold">
          <h1 class="font-bold text-2xl ml-5 mt-2 mb-4">Nilagang Baboy</h1>
        </div>
      </div>
      <div class="flex flex-col bg-white mt-10 ml-4 mr-5 w-96">
        <div class="flex flex-col items-center mb-3 mt-5">
          <img style="width: 350px; height: 180px;" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaGHLPWNxadtoTjM_HNO8r7pGkjXO5HS42YexGTxmOnA&s" alt="">
          <div class="absolute bg-white w-10 h-10 rounded-full" style="margin: 8px 0 0 18em;">
            <i class="fas fa-heart text-2xl" style="color: lightgray; margin: 5px 0 0 8px;"></i>
          </div>
        </div>
        ...
        <div class="font-bold">
          <h1 class="font-bold text-2xl ml-5 mt-2 mb-4">Tortang Talong</h1>
        </div>
      </div>
