...
<html class="scroll-smooth">
  ...
  <body class="bg-zinc-300">
    <div class="flex flex-col min-h-screen">
      ...
      <a href="payment">
        <div class="flex flex-col rounded-xl shadow-xl" style="background-color: white; width: 370px; height: 90px; margin-top: 20px; margin-left: 20px;">
          <div class="flex flex-row">
            ...
            <i class="fa-regular fa-circle-dot text-2xl" style="margin: 28px 0 0 120px; color: maroon;"></i>
          </div>
        </div>
      </a>
      <a href="cashonhand">
      ...
      <div class="flex flex-col justify-center items-center" style="margin-top: 90px;">
        <div class="bg-white" style="background-color: white; width: 360px; height: 170px; border-radius: 20px 20px 0 0;">
          ...
          <div class="flex flex-row mt-4">
            <span style="margin-left: 2em;">Subtotal</span>
            <span style="margin-left: 218px;">280</span>
          </div>
          <hr style="width: 310px; margin-left: 30px;">
          <div class="flex flex-row mt-4">
            <span style="margin-left: 2em;">School Fee</span>
            <span style="margin-left: 172px;">₱30,000</span>
          </div>
          <hr style="width: 310px; margin-left: 30px;">
          <div class="flex flex-row mt-4">
            <span class="font-bold" style="margin-left: 2em;">Total</span>
            <span style="margin-left: 212px;">₱30,280</span>
          </div>
        </div>
        <a href="qrcode">
