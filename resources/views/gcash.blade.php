...
<i class="fa-regular fa-circle-dot text-2xl" style="margin: 28px 0 0 160px; color: maroon;"></i>
</div>
</div>
...
<div class="flex flex-col justify-center items-center" style="margin-top: 180px;">
    <div class="bg-white" style="background-color: white; width: 360px; height: 80px;">
        <div class="flex flex-row">
            <span>Selected</span>
            <span>4</span>
        </div>
    ...
    <div>
    <button style="background-color: maroon; color: white;">PAY NOW</button>
    </div>
</div>
